...
//     const { initialCart } = useLoaderData();
//     return (
//         <div className='h-auto flex justify-center items-center my-40 '>
//             <div className='w-[1100px] h-auto  shadow px-5 rounded-lg border'>
//                 <div>
//                     <h1 className='mx-1 my-10 font-bold text-2xl'>Shopping Cart</h1>
//                 </div>
//                 <div className='flex justify-between items-center bg-[#f5f7f9] h-10 px-3 my- rounded-md'>
//                     <div className='w-[230px] flex pl-10'>
//                         <p>Image</p>
//                     </div>
...
//                         <h1>Price</h1>
//                     </div>
//                     <div className='w-[230px] flex justify-center pl-20'>
//                         <h1>Remove</h1>
//                     </div>
//                 </div>
//                 {
//                     initialCart.map((product) => (
//                         <div key={product.id} className='flex justify-between items-center border  shadow-md  rounded-lg my-4'>
//                             <div className='w-[230px] '>
//                                 <img className='w-[120px] h-[120px] ' src={product.img} alt="" />
//                             </div>
//                             <div className='w-[230px] flex justify-center'>
//                                 <h1>{product.name}</h1>
//                             </div>
...
//                             <div className='w-[230px] flex justify-center pl-20'>
//                                 <button onClick={() => removeFromDb(product.id, product.img, product.price, product.quantity)}> {<FontAwesomeIcon className='w-7 h-7 mr-4 ' icon={faCircleXmark} />}</button>
//                             </div>
//                         </div>
//                     ))
//                 }
...
//                         <p className=' my-1'>Choose if you have a discount code or reward points you want to use or would like to estimate your delivery cost.</p>
//                     </div>
//                     <div className='flex justify-between items-center bg-[#f1f5f9] h-[80px]  rounded-lg'>
//                         <div className='flex mx-5 items-center'>
//                             <div>
//                                 <input className='input input-bordered font-bold  bg-transparent' type="text" placeholder='Promo / Coupon Code' />
//                             </div>
//                             <div>
//                                 <button className='btn border-none btn-primary mx-2 btn-outline rounded-sm ring-2 ring-[#3749bb]'>Apply Coupon</button>
//                             </div>
...
//                             <div>
//                                 <input className='input input-bordered font-bold  bg-[#f3f5f7]' type="text" placeholder='Enter your gift voucher code here' />
//                             </div>
//                             <div>
//                                 <button className='btn border-none btn-primary mx-2 btn-outline rounded-sm ring-2 ring-[#3749bb]'>Apply Voucher</button>
//                             </div>
...
//                         <div>
//                             <button className='btn btn-primary text-white w-[160px] rounded-sm'>Continue Shopping</button>
//                         </div>
//                         <div>
//                             <button className='btn btn-primary text-white  w-[160px] rounded-sm'>Confirm Order</button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
